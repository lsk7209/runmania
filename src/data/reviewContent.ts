...
export const reviewData: Record<string, ReviewContent> = {
  ...
  "ASICS Novablast 5": {
    ...
    cons: [
      "Not very stable for heavy overpronators",
      "Upper fit can feel average",
    ],
    verdict:
      "A strong all-rounder for runners who want a lively daily trainer without moving to a plated shoe.",
    rating: 4.4,
    detailedReview:
    ...
    faq: [
      {
        q: "Is Novablast 5 good for beginners?",
        a: "Yes. It is lively but still forgiving enough for most beginner neutral runners.",
      },
      {
        q: "Can it handle tempo runs?",
        a: "Yes. It is not a pure speed shoe, but it handles steady and moderate tempo work well.",
      },
      {
        q: "Is it stable?",
        a: "It is stable enough for many neutral runners, but it is not a true support shoe.",
      },
    ],
  },
  "Hoka Clifton 10": {
    ...
    verdict:
      "A dependable comfort-focused trainer for runners who value consistency over flashy speed.",
    rating: 4.2,
    detailedReview:
    ...
    faq: [
      {
        q: "Is Clifton 10 good for long runs?",
        a: "Yes. It is especially good for comfortable long runs at relaxed pace.",
      },
      {
        q: "Is it soft or firm?",
        a: "It leans comfortable and moderately soft, not mushy.",
      },
      {
        q: "Can beginners use it as a first shoe?",
        a: "Yes. It is one of the safer first-shoe options for neutral runners.",
      },
    ],
  },
  "Brooks Ghost 16": {
    ...
    verdict:
      "A practical and safe neutral trainer that prioritizes consistency over novelty.",
    rating: 4.1,
    detailedReview:
    ...
    faq: [
      {
        q: "Is Ghost 16 stable?",
        a: "For a neutral shoe, yes. It is not a support model, but it feels planted and predictable.",
      },
      {
        q: "Is it good for wide feet?",
        a: "Yes. Its width options are one of its strongest points.",
      },
      {
        q: "Can it be a one-shoe rotation?",
        a: "Yes. For many runners it works well as a single daily trainer.",
      },
    ],
  },
  "Saucony Triumph 22": {
    pros: [
      ...
      "Premium foam feel",
      "Strong recovery-run option",
    ],
    cons: ["Not very nimble", "Heavier than tempo-focused trainers"],
    verdict:
      "A comfort-heavy long-run shoe for runners who want softness and protection over speed.",
    rating: 4.5,
    detailedReview:
    ...
    idealFor: [
      "Long runs",
      "Recovery runs",
      "Runners wanting plush cushioning",
    ],
    ...
    faq: [
      {
        q: "Is Triumph 22 good for long runs?",
        a: "Yes. Long aerobic mileage is one of its best use cases.",
      },
      {
        q: "Is it too soft?",
        a: "For some runners it may feel very plush, but many will find it controlled enough for easy running.",
      },
      {
        q: "Can beginners use it?",
        a: "Yes, especially if they value comfort and do not mind a slightly heavier shoe.",
      },
    ],
  },
  "Nike Invincible 3": {
    ...
    verdict:
      "A max-soft option for runners who want easy-run comfort and are willing to manage some instability.",
    rating: 4.1,
    detailedReview:
    ...
    faq: [
      {
        q: "Is Invincible 3 stable?",
        a: "It is stable enough for some neutral runners, but it is not a support-first model.",
      },
      {
        q: "Is it good for recovery runs?",
        a: "Yes. Recovery running is one of its strongest use cases.",
      },
      {
        q: "Can beginners use it?",
        a: "Yes, but beginners who need more support should compare other options.",
      },
    ],
  },
  "Puma Deviate Nitro 3": {
    pros: [
      "Versatile plated ride",
      "Good value",
      "Useful for tempo and race prep",
    ],
    cons: ["Not as smooth as top-tier supershoes", "Upper fit may feel narrow"],
    verdict:
      "A practical plated trainer for runners who want speed-oriented value without paying supershoe prices.",
    rating: 4.3,
    detailedReview:
    ...
    idealFor: [
      "Tempo runs",
      "Runners wanting a plated trainer",
      "Value-focused speed work",
    ],
    ...
    faq: [
      {
        q: "Is Deviate Nitro 3 a race shoe?",
        a: "It can race, but it is best described as a versatile plated trainer.",
      },
      {
        q: "Can beginners use it?",
        a: "Yes, but beginners do not need it as a first shoe.",
      },
      {
        q: "Is it good value?",
        a: "Yes. Value is one of its strongest selling points.",
      },
    ],
  },
  "Mizuno Wave Rider 28": {
    ...
    cons: [
      "Firmer than many modern trainers",
      "Less bounce than premium foams",
    ],
    verdict:
      "A controlled trainer for runners who prefer structure and consistency over softness.",
    rating: 4.0,
    detailedReview:
    ...
    idealFor: [
      "Runners preferring firmer shoes",
      "Daily mileage",
      "Stable-feel neutral runners",
    ],
    ...
    faq: [
      {
        q: "Is Wave Rider 28 soft?",
        a: "Not especially. It leans more controlled and moderately firm.",
      },
      {
        q: "Is it durable?",
        a: "Yes. Durability is one of the line's stronger points.",
      },
      {
        q: "Who should avoid it?",
        a: "Runners who want very soft landings or a trampoline-like ride.",
      },
    ],
  },
  "On Cloudmonster 2": {
    pros: [
      "Distinct rocker feel",
      "Bouncy for a max shoe",
      "Good for long steady runs",
    ],
    cons: ["Price is high", "Ride feel is not for everyone"],
    verdict:
      "A premium max-cushion option with a firmer bounce and unique rocker character.",
    rating: 4.2,
    detailedReview:
    ...
    idealFor: [
      "Long runs",
      "Runners who want bounce with stack",
      "Premium buyers",
    ],
    ...
    faq: [
      {
        q: "Is Cloudmonster 2 soft?",
        a: "It is cushioned, but it feels firmer and bouncier than many max-cushion rivals.",
      },
      {
        q: "Is it worth the price?",
        a: "Only if you specifically like the On ride style and rocker feel.",
      },
      {
        q: "Can it be a daily trainer?",
        a: "Yes, especially for runners who like a premium, energetic long-run shoe.",
      },
    ],
  },
  "New Balance FuelCell Rebel v4": {
    ...
    verdict:
      "A highly enjoyable lightweight trainer for runners who want speed feel without plated stiffness.",
    rating: 4.4,
    detailedReview:
    ...
    notFor: [
      ...
      "Heavy heel strikers wanting structure",
    ],
    tips: [
    ...
    faq: [
      {
        q: "Is Rebel v4 a race shoe?",
        a: "It can race shorter events, but it is mainly a lightweight trainer.",
      },
      {
        q: "Is it stable?",
        a: "Stability is not its strength. It is best for neutral runners.",
      },
      {
        q: "Why choose it over a plated shoe?",
        a: "Because it feels lighter, more natural, and less rigid underfoot.",
      },
    ],
  },
  "Adidas Adizero SL 2": {
    pros: [
      "Light and efficient",
      "Good value",
      "Works for daily and faster runs",
    ],
    cons: ["Not plush", "Upper refinement is average"],
    verdict:
      "A strong budget-performance trainer for runners who want one lighter shoe to cover multiple jobs.",
    rating: 4.1,
    detailedReview:
    ...
    faq: [
      {
        q: "Is Adizero SL 2 a beginner shoe?",
        a: "It can work for some beginners, but comfort-first beginners may prefer a softer trainer.",
      },
      {
        q: "Is it a speed shoe?",
        a: "It sits between daily trainer and lightweight workout shoe.",
      },
      {
        q: "Is it good value?",
        a: "Yes. Value is one of the biggest reasons to buy it.",
      },
    ],
  },
  "Nike Structure 25": {
    pros: [
      "Useful guidance",
      "Reliable daily ride",
      "Good option for mild stability needs",
    ],
    cons: [
      "Less lively than Pegasus",
      "Support feel may be unnecessary for neutral runners",
    ],
    verdict:
      "A sensible daily stability trainer for runners who want more guidance than a neutral Nike model offers.",
    rating: 4.2,
    detailedReview:
    ...
    idealFor: [
      "Mild overpronators",
      "Daily support shoe users",
      "Nike runners wanting more guidance",
    ],
    ...
    faq: [
      {
        q: "Is Structure 25 a strong stability shoe?",
        a: "It gives meaningful guidance, but it is not the most aggressive support shoe on the market.",
      },
      {
        q: "Who should choose it over Pegasus?",
        a: "Runners who want more structure and support in daily training.",
      },
      {
        q: "Can beginners use it?",
        a: "Yes, especially beginners who suspect they need mild stability support.",
      },
    ],
  },
  "호카 클리프턴 9": {
