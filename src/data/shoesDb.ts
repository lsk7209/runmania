...
export const SHOES_DB: Shoe[] = [
  {
    ...
    type: "cushion",
    widthAvailable: ["표준", "2E", "4E"],
    bestFor: ["wide-foot", "soft-cushion", "beginner", "knee-pain"],
    banFor: [],
  ...
  },
  {
    ...
    type: "max-cushion",
    widthAvailable: ["표준", "2E", "4E"],
    bestFor: ["wide-foot", "overweight", "knee-pain", "soft-cushion", "sole-pain"],
    banFor: [],
  ...
  },
  {
    ...
    type: "max-cushion",
    widthAvailable: ["표준", "2E"],
    bestFor: ["overweight", "knee-pain", "soft-cushion", "sole-pain"],
    banFor: ["wide-foot"],
  ...
  },
  {
    ...
    type: "cushion",
    widthAvailable: ["표준", "2E"],
    bestFor: ["wide-foot", "soft-cushion", "sole-pain"],
    banFor: [],
  ...
  },
  {
    ...
    type: "neutral",
    widthAvailable: ["표준"],
    bestFor: ["narrow-foot", "bouncy-cushion"],
    banFor: ["wide-foot"],
